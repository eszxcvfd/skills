...
Whichever installer is used, repository-facing skills still consult the shared
[`Work Routing`](../../skills/WORK-ROUTING.md) reference. Distribution changes
where the skill is loaded from; it does not change the target repository's
document ownership, lane selection, plan, or closeout rules.
