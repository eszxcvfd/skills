...
When a docs page describes repository-facing behavior, consult the shared
[`Work Routing`](../skills/WORK-ROUTING.md) reference first. The page may
explain a skill's role, but it must not create a competing rule for document
ownership, lane selection, plan contents, or closeout.
