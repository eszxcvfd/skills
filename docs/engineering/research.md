...
Non-Claude agents can copy just this skill with `npx skills@latest add eszxcvfd/skills --skill=research`.

[Source](https://github.com/eszxcvfd/skills/tree/main/skills/engineering/research)
