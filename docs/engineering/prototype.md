...
Non-Claude agents can copy just this skill with `npx skills@latest add eszxcvfd/skills --skill=prototype`.

[Source](https://github.com/eszxcvfd/skills/tree/main/skills/engineering/prototype)
