...
- **[orchestrator-herdr](./orchestrator-herdr/SKILL.md)** — On Herdr: plan-confirm, route project skills, spawn OpenCode workers with STATUS under `.scratch/orchestrator/`.
