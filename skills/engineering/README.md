...
- **[setup-matt-pocock-skills](./setup-matt-pocock-skills/SKILL.md)** — Configure the issue tracker, minimal project docs, detached Paseo contract, and model defaults.
