...
All repository-facing engineering skills consult the shared
[Work Routing](../WORK-ROUTING.md) reference before acting. It is the single
source for the exact project documents and lane/plan ownership rules.
...
- **[setup-matt-pocock-skills](./setup-matt-pocock-skills/SKILL.md)** — Configure this repo for the engineering skills (issue tracker, triage labels, domain docs, and Work Routing documents). Run once per repo.
