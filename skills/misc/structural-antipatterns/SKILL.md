---
name: structural-antipatterns
description: Use when reviewing system design, architecture proposals, implementation plans, module boundaries, proof claims, or suspected overengineering for structural misfit and avoidable tax.
---

# Structural Antipatterns

Use this as a design-control lens. It is not a checklist. Report only patterns supported by bounded evidence, and return `BORING_STANDARD` or `JUSTIFIED_DEVIATION` when the design has the needed owner, information, proof route, and proportionate cost.

## Review output

```text
VERDICT: BORING_STANDARD|JUSTIFIED_DEVIATION|STRUCTURAL_MISFIT
EVIDENCE: <file:line, plan section, runtime observation, or explicit uncertainty>
MISFIT: <specific mechanism gap or avoidable tax>
BORING_ROUTE: <simpler owner/mechanism if one exists>
PROOF_REQUIRED: <what would disconfirm the finding>
```
