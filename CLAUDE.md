...
Repository-facing work starts with the shared [Work Routing](./skills/WORK-ROUTING.md)
reference. It owns the smallest project-document set, lane selection, plan
ownership, and closeout rules; skill-local documents must point to it rather
than inventing a competing routing system.
